...
1. Issues with positioning scrollview with assets. Moving scrollview and image gives different results. What is the relationship to the X/Y cordinates. 

### Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='/dropit-example.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
